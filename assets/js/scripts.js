...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 300) {
            ...
            logo.attr('src', 'uithemez/item/vie1/vie-dark/img/logo-dark.png');

        } else {

            navbar.removeClass("nav-scroll");
            logo.attr('src', 'uithemez/item/vie1/vie-dark/img/logo-light.png');
        }
    });
    ...
    $('.topnav .menu-icon').on('click', function () {
        ...
        if (open) {
            ...
            logoChan.attr('src', 'uithemez/item/vie1/vie-dark/img/logo-light.png');
            ...
            logoChan.attr('src', 'uithemez/item/vie1/vie-dark/img/logo-dark.png');
